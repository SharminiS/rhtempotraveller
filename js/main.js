(function ($) {
    ...
    // Blink popup every 2 seconds
    setInterval(function () {
      autoPopupForm.classList.toggle('blink');
    }, 2000);
    
    // Form validation logic
    const form = document.querySelector('form');
    const nameInput = document.getElementById('auto-popup-name');
    const phoneInput = document.getElementById('auto-popup-phone');
    const emailInput = document.getElementById('auto-popup-email');
    const serviceInput = document.getElementById('service');
    const messageInput = document.getElementById('auto-popup-message');
